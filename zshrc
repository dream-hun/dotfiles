...
alias art="php artisan"
alias static="vendor/bin/phpstan analyse --memory-limit=2G"
...
export PATH="/home/midnightcompiler/.config/herd-lite/bin:$PATH"
export PHP_INI_SCAN_DIR="/home/midnightcompiler/.config/herd-lite/bin:$PHP_INI_SCAN_DIR"
